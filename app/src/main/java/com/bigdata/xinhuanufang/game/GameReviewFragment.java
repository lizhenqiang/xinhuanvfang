...
public class GameReviewFragment extends Fragment implements OnClickListener, MyScrollView.OnScrollListener {
	...
	private List<TextView> termList;// 公斤级集合
	private List<TextView> zhanwujiList;
	...
	private Iterator<TextView> tv; // 集合遍历器

	private View WeightContentView; // 体重公斤级
	private View clubContentView; // 俱乐部
	private View zhanwujiContentView; // 战无极

	private TextView game_nan_zhongliangji;// 体重公斤级
	private TextView game_nan_qingliangji;// 体重公斤级
	private TextView game_nan_ciqingliangji;// 体重公斤级
	private TextView game_nv_zhongliangji;// 体重公斤级
	private TextView game_nv_qingliangji;// 体重公斤级
	private TextView game_nv_ciqingliangji;// 体重公斤级

	private TextView game_zhanwuji_quanwang;// 战无极
	private TextView game_zhanwuji_quanjineng1;// 战无极
	private TextView game_zhanwuji_quanjineng2;// 战无极
	private TextView game_saifadou_quanwang;// 战无极
	private TextView game_saifadou_quanjineng1;// 战无极
	private TextView game_saifadou_quanjineng2;// 战无极
	...
	private TextView game_gongfushijiebei;
...
//		});
	...
	private void initView() {
		...
		termList = new ArrayList<TextView>();
		zhanwujiList = new ArrayList<TextView>();
	...
	public void getNetWorkData(String weightvideo_id, String areavideo_id,
		...
		// weightvideo_id="2";
		// }
		System.out.println("赛事回看"+Config.ip + Config.app + "/video_list."
...
//				getNetWorkData("2", "2", "1", "1");
			...
			case R.id.game_nan_zhongliangji:
				isChecks(game_nan_zhongliangji);
//				if (isweight) {
					weightvideo_id = 1;
					tizhong_gongjinji.setText("男:50-56kg");
					isweight=false;
//				}else{
//					weightvideo_id = 0;
...
//				}
			...
			case R.id.game_nan_qingliangji:
				isChecks(game_nan_qingliangji);
//				if (isweight) {
					weightvideo_id = 2;
					tizhong_gongjinji.setText("男:66-79kg");
					isweight=false;
//				}else{
//					weightvideo_id = 0;
//					tizhong_gongjinji.setText("体重公斤级");
...
//				}
			...
			case R.id.game_nan_ciqingliangji:
				isChecks(game_nan_ciqingliangji);
//				if (isweight) {
					weightvideo_id = 3;
					tizhong_gongjinji.setText("男:80-120kg");
					isweight=false;
//				}else{
//					weightvideo_id = 0;
//					tizhong_gongjinji.setText("体重公斤级");
...
//				}
			...
			case R.id.game_nv_zhongliangji:
				isChecks(game_nv_zhongliangji);
//				if (isweight) {
					weightvideo_id = 4;
					tizhong_gongjinji.setText("女:50-65kg");
					isweight=false;
//				}else{
//					weightvideo_id = 0;
//					tizhong_gongjinji.setText("体重公斤级");
...
//				}
			...
			case R.id.game_nv_qingliangji:
				isChecks(game_nv_qingliangji);
//				if (isweight) {
					weightvideo_id = 5;
					tizhong_gongjinji.setText("女:66-79kg");
					isweight=false;
//				}else{
//					weightvideo_id = 0;
//					tizhong_gongjinji.setText("体重公斤级");
...
//				}
			...
			case R.id.game_nv_ciqingliangji:
				isChecks(game_nv_ciqingliangji);
//				if (isweight) {
					weightvideo_id = 6;
					tizhong_gongjinji.setText("女:80-120kg");
					isweight=false;
//				}else{
//					weightvideo_id = 0;
//					tizhong_gongjinji.setText("体重公斤级");
...
//				}
			...
			case R.id.game_zhanwuji_quanwang:
				isCheckZhan(game_zhanwuji_quanwang);
//				if (iszhanwuji) {
					zhanwuji = 1;
					zhanwuji_saifadou.setText("我是拳王");
					iszhanwuji=false;
//				}else{
//					zhanwuji = 0;
...
//				}
			...
			case R.id.game_zhanwuji_quanjineng1:
				isCheckZhan(game_zhanwuji_quanjineng1);
//				if (iszhanwuji) {
					zhanwuji = 2;
...
//				}
			...
			case R.id.game_zhanwuji_quanjineng2:
				isCheckZhan(game_zhanwuji_quanjineng2);
//				if (iszhanwuji) {
					zhanwuji = 3;
...
//				}
			...
			case R.id.game_saifadou_quanwang:
				isCheckZhan(game_saifadou_quanwang);
//				if (iszhanwuji) {
					zhanwuji = 4;
...
//				}
			...
			case R.id.game_saifadou_quanjineng1:
				isCheckZhan(game_saifadou_quanjineng1);
//				if (iszhanwuji) {
					zhanwuji = 5;
					zhanwuji_saifadou.setText("中外对抗赛");
					iszhanwuji=false;
//				}else{
//					zhanwuji = 0;
//					zhanwuji_saifadou.setText("战无极/赛法斗");
...
//				}
			...
			case R.id.game_saifadou_quanjineng2:
				isCheckZhan(game_saifadou_quanjineng2);
//				if (iszhanwuji) {
					zhanwuji = 6;
...
//				}
				...
				getNetWorkData(String.valueOf(weightvideo_id),
						...
						String.valueOf(page));
				break;
			case R.id.game_gongfushijiebei:
				isCheckZhan(game_gongfushijiebei);
//				if (iszhanwuji) {
					zhanwuji = 7;
...
//					zhanwuji = 0;
//					zhanwuji_saifadou.setText("战无极/赛法斗");
//					game_gongfushijiebei.setBackgroundColor(Color.WHITE);
//					game_gongfushijiebei.setSelected(false);
					iszhanwuji=true;
//				}
				popupWindow.dismiss();
				list.clear();
	...
	private void showPopupWindow(View v, String str) {
		...
		if (str == "weight") {
			...
			if (clubContentView == null) {
				...
				clubContentView.setVisibility(View.GONE);
	...
	private void initZhanWuJiData(View zhanwujiContentView) {
		game_zhanwuji_quanwang = (TextView) zhanwujiContentView
				.findViewById(R.id.game_zhanwuji_quanwang);
		game_zhanwuji_quanjineng1 = (TextView) zhanwujiContentView
				.findViewById(R.id.game_zhanwuji_quanjineng1);
		game_zhanwuji_quanjineng2 = (TextView) zhanwujiContentView
				.findViewById(R.id.game_zhanwuji_quanjineng2);
		game_saifadou_quanwang = (TextView) zhanwujiContentView
				.findViewById(R.id.game_saifadou_quanwang);
		game_saifadou_quanjineng1 = (TextView) zhanwujiContentView
				.findViewById(R.id.game_saifadou_quanjineng1);
		game_saifadou_quanjineng2 = (TextView) zhanwujiContentView
				.findViewById(R.id.game_saifadou_quanjineng2);
		game_gongfushijiebei = (TextView) zhanwujiContentView.findViewById(R.id.game_gongfushijiebei);
		zhanwujiList.add(game_zhanwuji_quanwang);
		zhanwujiList.add(game_zhanwuji_quanjineng1);
		zhanwujiList.add(game_zhanwuji_quanjineng2);
		zhanwujiList.add(game_saifadou_quanwang);
		zhanwujiList.add(game_saifadou_quanjineng1);
		zhanwujiList.add(game_saifadou_quanjineng2);
		zhanwujiList.add(game_gongfushijiebei);
		...
		game_gongfushijiebei.setOnClickListener(this);
	}

	private void initWeightData(View WeightContentView) {
		game_nan_zhongliangji = (TextView) WeightContentView
				.findViewById(R.id.game_nan_zhongliangji);
		game_nan_qingliangji = (TextView) WeightContentView
				.findViewById(R.id.game_nan_qingliangji);
		game_nan_ciqingliangji = (TextView) WeightContentView
				.findViewById(R.id.game_nan_ciqingliangji);
		game_nv_zhongliangji = (TextView) WeightContentView
				.findViewById(R.id.game_nv_zhongliangji);
		game_nv_qingliangji = (TextView) WeightContentView
				.findViewById(R.id.game_nv_qingliangji);
		game_nv_ciqingliangji = (TextView) WeightContentView
				.findViewById(R.id.game_nv_ciqingliangji);
		termList.add(game_nan_zhongliangji);
		termList.add(game_nan_qingliangji);
		termList.add(game_nan_ciqingliangji);
		termList.add(game_nv_zhongliangji);
		termList.add(game_nv_qingliangji);
		termList.add(game_nv_ciqingliangji);
	...
	public void isCheckZhan(TextView localBtn) {
		tv = zhanwujiList.iterator();
		while (tv.hasNext()) {
			TextView btn = tv.next();

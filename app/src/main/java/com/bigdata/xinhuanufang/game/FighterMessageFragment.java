...
public class FighterMessageFragment extends Fragment implements OnClickListener, MyScrollView.OnScrollListener {
	...
	private Button weight7; // 山东Button
	private Button weight8; // 南京Button
	private Button weight9; // 西安Button

	// 年龄
	private Button age1; // 北京Button
	private Button age2; // 上海Button
	private Button age3; // 海南Button
	private Button age4; // 黑龙江Button
	private Button age5; // 广州Button
	private Button age6; // 山西Button
	private Button age7; // 山东Button
	private Button age8; // 南京Button
...
//				}
				...
				break;
			case R.id.weight7:
				isCheckWeight(weight7);
				if (isweight) {
					weight_id = 7;
					isweight=false;
				}else{
					weight_id = 0;
					weight7.setTextColor(0xff333333);
					weight7.setSelected(false);
					isweight=true;
				}
				popupWindow.dismiss();
				list.clear();
				...
				break;
			case R.id.weight8:
				isCheckWeight(weight8);
				if (isweight) {
					weight_id = 8;
					isweight=false;
				}else{
					weight_id = 0;
					weight8.setTextColor(0xff333333);
					weight8.setSelected(false);
					isweight=true;
				}
				popupWindow.dismiss();
				list.clear();
				...
				break;
			case R.id.weight9:
				isCheckWeight(weight9);
				if (isweight) {
					weight_id = 9;
					isweight=false;
				}else{
					weight_id = 0;
					weight9.setTextColor(0xff333333);
					weight9.setSelected(false);
					isweight=true;
				}
				popupWindow.dismiss();
				list.clear();
...
//				}
	...
	private void setAgeData() {
		...
		age2.setText("31~60岁");
		age3.setText("24-26岁");
		age3.setVisibility(View.INVISIBLE);
		age4.setText("27-29岁");
		age5.setText("30-32岁");
		age6.setText("33-35岁");
		age7.setText("36-38岁");
	...
	private void setCountryData() {
		...
		btn_pClub_nanjing.setText("英国");
		btn_pClub_xian.setText("泰国");
	}

	private void setWeightData() {
		// TODO Auto-generated method stub
		weight1.setText("50~65KG");
		weight2.setText("66~79KG");
		weight3.setText("80~120KG");
		weight4.setText("50~65KG");
		weight5.setText("66~79KG");
		weight6.setText("80~120KG");
		weight7.setText("63公斤级");
		weight8.setText("66公斤级");
		weight9.setText("72公斤级");
	}
	...
	public void initWeightData(View WeightContentView) {
		...
		weight7 = (Button) WeightContentView.findViewById(R.id.weight7);
		weight8 = (Button) WeightContentView.findViewById(R.id.weight8);
		weight9 = (Button) WeightContentView.findViewById(R.id.weight9);
...
//		weight2.setSelected(true);
		...
		weightList.add(weight7);
		weightList.add(weight8);
		weightList.add(weight9);
		...
		weight7.setOnClickListener(this);
		weight8.setOnClickListener(this);
		weight9.setOnClickListener(this);
	}
...
//		btn_pClub_beijing.setSelected(true);
	...
	private void initAgeData(View AgeContentView) {
		...
		age4 = (Button) AgeContentView.findViewById(R.id.age4);
		age5 = (Button) AgeContentView.findViewById(R.id.age5);
		age6 = (Button) AgeContentView.findViewById(R.id.age6);
		age7 = (Button) AgeContentView.findViewById(R.id.age7);
		age8 = (Button) AgeContentView.findViewById(R.id.age8);
...
//		age1.setSelected(true);
		...
		age7.setOnClickListener(this);
		age8.setOnClickListener(this);
